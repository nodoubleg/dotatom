(function() {
  ...
  LinterErb = (function(_super) {
    ...
    LinterErb.syntax = ['text.html.erb', 'text.html.ruby'];
    ...
    function LinterErb(editor) {
      ...
      this.executablePathListener = atom.config.observe('linter-erb.erbExecutablePath', (function(_this) {
        return function() {
    ...
    LinterErb.prototype.lintFile = function(filePath, callback) {
      ...
      erbStdout = (function(_this) {
        return function(output) {
          if (_this.editor.getGrammar().scopeName === 'text.html.ruby') {
